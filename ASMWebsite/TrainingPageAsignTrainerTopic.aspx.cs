...
{
    public partial class TrainingPageAsignTrainerTopic : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd1 = new SqlCommand("Insert into TrainerTopic (UserID,TopicID) values (@UserID,@TopicID);", con);
