<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingPageAsignTrainerTopic.aspx.cs" Inherits="ASMWebsite.TrainingPageAsignTrainerTopic" %>
            ...
            <table style="width: 100%;">                                               
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource1" DataTextField="UserID" DataValueField="UserID">
                        </asp:DropDownList>
