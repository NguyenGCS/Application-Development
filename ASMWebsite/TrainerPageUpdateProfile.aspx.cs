...
{
    public partial class TrainerPageUpdateProfile : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (ds.Tables[0].Rows.Count != 0)
            {
                ...
                SqlCommand cmd1 = new SqlCommand("Update info set   Name=@Name," +
                                                                    "DoB=@DoB," +
                                                                    "Address=@Address," +
                                                                    "Email=@Email," +
                ...
                cmd1.Parameters.AddWithValue("@Department", TextBox7.Text);
                cmd1.Parameters.AddWithValue("@Experience", TextBox8.Text);
            ...
            {
                int a = Convert.ToInt32(Session["userSession"].ToString());
                SqlCommand cmd1 = new SqlCommand("insert into info " +
                    "(UserID,Name,DoB,Address,Email,Department,Experience,Phone,WorkingPlace) " +
                                                             "values " +
                    "(@UserID,@Name,@DoB,@Address,@Email,@Department,@Experience,@Phone,@WorkingPlace);", con);
                cmd1.Parameters.AddWithValue("@Name", TextBox3.Text);
                cmd1.Parameters.AddWithValue("@DoB", TextBox4.Text);
                cmd1.Parameters.AddWithValue("@Address", TextBox5.Text);
                cmd1.Parameters.AddWithValue("@Email", TextBox6.Text);
