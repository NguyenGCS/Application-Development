<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingPageSearchDeleteUpdateCourse.aspx.cs" Inherits="ASMWebsite.TrainingPageSearchCourse" %>
...
<body class="aboutus0">
    <form id="form1" runat="server">
        ...
        <div class="aboutus">
            ...
            <h1>UPDATE SEARCH DELETE COURSE PAGE</h1>
            ...
            <asp:GridView ID="GridView1" runat="server" EmptyDataText="There is no such COURSE, please use the Create function" ></asp:GridView>
