<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingPageSearchDeleteUpdateTopic.aspx.cs" Inherits="ASMWebsite.TrainingPageSearchTopic" %>
...
<body class="aboutus0">
    <form id="form1" runat="server">
        ...
        <div class="aboutus">
            ...
            <h1>UPDATE SEARCH DELETE TOPIC PAGE</h1>
            ...
            <asp:GridView ID="GridView1" runat="server" EmptyDataText="There is no such TOPIC, please use the Create function" ></asp:GridView>
