...
{
    public partial class TrainingPageSearchCategory : System.Web.UI.Page
    {
        ...
        protected void ButSearch_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from [Category] where CategoryID=@CatID  and CategoryDescription != 'Deleted'";
        ...
        protected void DelBut_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "Update [Category] set CategoryDescription = 'Deleted' where [CategoryID] = @CatID";
            cmd.Parameters.AddWithValue("@CatID", TxtSearch.Text);
            cmd.ExecuteNonQuery();
        ...
        protected void UpdateBut_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("TrainingPageUpdateCategory.aspx");
        }
    }
}