...
{
    public partial class TrainingPageUpdateCategory : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (ds.Tables[0].Rows.Count != 0)
            {
                ...
                SqlCommand cmd1 = new SqlCommand("Update Category set CategoryDescription=@CategoryDescription,TopicID=@TopicID where CategoryID=@CategorySession", con);
                cmd1.Parameters.AddWithValue("@CategoryDescription", TextBox3.Text);
                cmd1.Parameters.AddWithValue("@TopicID", DropDownList1.SelectedValue);
                cmd1.Parameters.Add("@CategorySession", SqlDbType.Int);
                cmd1.Parameters["@CategorySession"].Value = a;
