<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainerPageUpdateProfile.aspx.cs" Inherits="ASMWebsite.TrainerPageUpdateProfile" %>
    ...
    <form id="form1" runat="server">
        <div class="navbar">
            <ul>
                ...
                <li><a href="TrainerPage.aspx">Trainer Page</a> </li>
        ...
        <div class="aboutus">    
            <table style="width: 100%;">                                               
                ...
                <tr>
                    <td class="texttr">Department</td>
                    <td class="auto-style2">
                        <asp:TextBox ID="TextBox7" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="texttr">Experience</td>
                    <td class="auto-style2">
