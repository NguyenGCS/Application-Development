...
{
    public partial class TrainingPageUpdateTopic : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters["@TopicID"].Value = b;
            ...
            if (ds.Tables[0].Rows.Count != 0)
            {
                ...
                SqlCommand cmd1 = new SqlCommand("Update Topic set TopicDescription=@TopicDescription where TopicID=@TopicSession", con);
                cmd1.Parameters.AddWithValue("@TopicDescription", TextBox3.Text);
                cmd1.Parameters.Add("@TopicSession", SqlDbType.Int);
                cmd1.Parameters["@TopicSession"].Value = a;
