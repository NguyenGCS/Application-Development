<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingPageAsignCourseCategory.aspx.cs" Inherits="ASMWebsite.TrainingPageAsignCourseCategory" %>
            ...
            <table style="width: 100%;">                                               
                <tr>
                    ...
                    <td class="auto-style2">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:webappnew1 %>" SelectCommand="SELECT [CategoryID] FROM [Category] Where [CategoryDescription] != 'Deleted'"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
