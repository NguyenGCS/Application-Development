<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingPageUpdateCategory.aspx.cs" Inherits="ASMWebsite.TrainingPageUpdateCategory" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="aboutus">    
            <table style="width: 100%;">                                               
                <tr>
                    <td class="texttr">Category Description</td>
