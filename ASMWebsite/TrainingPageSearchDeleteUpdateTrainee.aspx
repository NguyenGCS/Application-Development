<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingPageSearchDeleteUpdateTrainee.aspx.cs" Inherits="ASMWebsite.TrainingPageSearchTrainee" %>
...
<body class="aboutus0">
    <form id="form1" runat="server">
        ...
        <div class="aboutus">
            ...
            <h1>UPDATE SEARCH DELETE TRAINEE PAGE</h1>
            ...
            <asp:GridView ID="GridView1" runat="server" EmptyDataText="There is no such user" ></asp:GridView>
